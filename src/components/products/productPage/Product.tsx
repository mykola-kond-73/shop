...
type PropsType=Omit<ProductType,'_id'|'avatar'|'section'>&{id:string}
        ...
        <>
            <div className={classes.root} >
                <div className={classes.carouselWrapper}>
                    <div data-testid="product-item-carousel" className={classes.carousel}>
                        <Carousel effect="fade" style={{ height: '100%' }}>
                            {props.photos && props.photos.map(elem => {
                                if (elem) {
                                    return <div key={`${elem}`}>
                                        <div className={classes.imageCarusel}>
                                            <Image
                                                width={300}
                                                height={300}
                                                src={elem}
                ...
                <div className={classes.popover}>
                    <PopoverProductCount total={props.total} productId={props.id} />
                </div>
                <div>
